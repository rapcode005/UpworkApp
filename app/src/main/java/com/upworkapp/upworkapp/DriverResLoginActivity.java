...
public class DriverResLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_res_login);
        ...
        fireBaseListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null) {
                    Intent intDriver = new Intent(DriverResLoginActivity.this, DriverMapActivity.class);
        ...
        bRegistration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sAuth.createUserWithEmailAndPassword(email,password)
                        .addOnCompleteListener(DriverResLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isComplete()) {
                            Toast.makeText(DriverResLoginActivity.this,"Sign up error.",Toast.LENGTH_LONG).show();
                        }
                        else {
        ...
        bLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(DriverResLoginActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isComplete()) {
                            Toast.makeText(DriverResLoginActivity.this,"Sign up error.",Toast.LENGTH_LONG).show();
